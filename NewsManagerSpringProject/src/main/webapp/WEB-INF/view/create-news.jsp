...
<table>
    <tr>
        ...
        <td>
            ...
            <form:form action="/news/savenews" modelAttribute="news" method="post">
                ${news_title}
                <form:input path="title" type="text" placeholder="${news_title}" value="" /> <br />
                ${news_brief}
                <form:input path="brief" type="text" placeholder="${news_brief}" value="" /> <br />
                ${news_content}
                <form:input path="content" type="text" placeholder="${news_content}" value="" /> <br /><br />
